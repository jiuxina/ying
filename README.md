...
- **高度可定制**：首页支持自定义圆形头像；桌面小部件支持 14 套样式预设（含神秘信封、时间胶囊、复古 CRT、霓虹灯牌、像素血条、镜像整活）、逐元素文字颜色 / 字号 / 粗细 / 对齐 / 显隐、按钮显隐、整体内容边距与垂直布局、壁纸取色、相册背景自由裁切与亮度 / 高斯模糊调节、节日皮肤；内容支持 Emoji、单位文案、精确到秒、农历星期、进度环、神秘模式、每日一句、临近高亮、数字 / 文字字体、在线字体库与本地字体导入；深色 / 浅色 / 跟随系统主题
...
- 桌面小部件 14 套材质样式：卡片、贴纸、照片、玻璃、拍立得、霓虹、像素、极简、神秘信封、时间胶囊、复古 CRT、霓虹灯牌、像素血条、镜像整活，并支持逐元素文字样式、按钮显隐、整体内容边距与垂直布局、壁纸取色、相册背景编辑与节日自动换肤
- 深色、浅色、跟随系统主题
- 手机浮动导航 / 平板玻璃侧栏响应式布局
