...
- **Android 原生 AppWidget**：小 / 中尺寸、单事件左右切换与多事件滚动列表、快速完成、自定义颜色 / 字号 / 字段、8 套样式预设（卡片 / 贴纸 / 照片 / 玻璃 / 拍立得 / 霓虹 / 像素 / 极简）、壁纸取色、相册背景、节日皮肤、Emoji、单位文案、精确到秒、农历星期、进度环、神秘模式、每日一句、数字字体与系统定时刷新
