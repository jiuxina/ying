...
- **高度可定制**：桌面小部件支持 8 套样式预设、自定义颜色 / 字号 / 字段、壁纸取色、相册背景与节日皮肤；深色 / 浅色 / 跟随系统主题
...
- **Android 原生 AppWidget**：小 / 中尺寸、左右切换、快速完成、自定义颜色 / 字号 / 字段、8 套样式预设（卡片 / 贴纸 / 照片 / 玻璃 / 拍立得 / 霓虹 / 像素 / 极简）、壁纸取色、相册背景、节日皮肤与系统定时刷新
